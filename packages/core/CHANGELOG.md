...
-   ChartCanvas no longer uses UNSAFE_componentWillReceiveProps ([a9643a2](https://github.com/reactivemarkets/react-candles/commit/a9643a2441d5d59a9587ef7f489613df6b0907fd))
-   Circular import causing use before initialization ([5921432](https://github.com/reactivemarkets/react-candles/commit/592143285d23b1b0f8f82157ea86e76f296ec73f))
...
-   **core:** fixing spreading interaction props ([c6a98fb](https://github.com/reactivemarkets/react-candles/commit/c6a98fbed9f3c08a6f912440b056b95e72596ef0))
...
-   Fixed warning from React about using getSnapshotBeforeUpdate without componentDidUpdate ([5da4fd0](https://github.com/reactivemarkets/react-candles/commit/5da4fd0430a916233d3e561f05f99c70266dcfac))
-   Resolved another circular dependency ([8ac704c](https://github.com/reactivemarkets/react-candles/commit/8ac704c8a557413933513a2b69ff608990f168ff))
...
-   do not capture wheel when pan and zoom disabled ([357383b](https://github.com/reactivemarkets/react-candles/commit/357383bbb823122806f6d7ec398bd885365bd908))
...
-   **core:** bug with panning on mobiles ([db34691](https://github.com/reactivemarkets/react-candles/commit/db34691d2bf8eb00277d6653034b3541bc75940d)), closes [#459](https://github.com/reactivemarkets/react-candles/issues/459)
...
**Note:** Version bump only for package @react-candles/core

# [1.0.0-alpha.14](https://github.com/reactivemarkets/react-candles/compare/v1.0.0-alpha.13...v1.0.0-alpha.14) (2020-09-02)

### Bug Fixes

-   **core:** correcting xExtents type ([d3607fe](https://github.com/reactivemarkets/react-candles/commit/d3607fedccda783badd2214b9d2ec27fa2faca31))
-   **core:** correcting zoom anchor types ([052981a](https://github.com/reactivemarkets/react-candles/commit/052981a9d7462c7c2e9bba4ae9486f1a1db14553))

# [1.0.0-alpha.13](https://github.com/reactivemarkets/react-candles/compare/v1.0.0-alpha.12...v1.0.0-alpha.13) (2020-09-01)

### Bug Fixes

-   **core:** correcting xextents props ([ec80146](https://github.com/reactivemarkets/react-candles/commit/ec80146bb171c21fd0daa41ac620b8081d6e6266))
-   fixing scaling when data is discontinuous ([4b20255](https://github.com/reactivemarkets/react-candles/commit/4b20255d05b4590c2a5fc196bf505c95a63431f0))
-   **core:** correcting bar width with continuous scales ([a967a18](https://github.com/reactivemarkets/react-candles/commit/a967a18347be6b8ad11d50da579911c9bd2f97ee))
...
-   **core:** displayXAccessor is optional ([d6a5dda](https://github.com/reactivemarkets/react-candles/commit/d6a5dda949c5178a8213cabda23d1178d4ea155a))

### Features

-   **core:** replaced onLoadMore with onLoadBefore & onLoadAfter ([4957c32](https://github.com/reactivemarkets/react-candles/commit/4957c32314db84131d3b34a8759dcc9ab28770c1))

# [1.0.0-alpha.10](https://github.com/reactivemarkets/react-candles/compare/v1.0.0-alpha.9...v1.0.0-alpha.10) (2020-08-28)

### Bug Fixes

-   **core:** children can be undefined or null ([17aa844](https://github.com/reactivemarkets/react-candles/commit/17aa844d19d87caf8b763cb07d3ea6ddc7c05d9c))
-   **core:** using type guard to check type of canvas children ([829ccfa](https://github.com/reactivemarkets/react-candles/commit/829ccfacd11da678a5920c37309fc991130b19ea)), closes [#417](https://github.com/reactivemarkets/react-candles/issues/417)
...
-   correcting zoomAnchor prop type ([981077b](https://github.com/reactivemarkets/react-candles/commit/981077b1e6e08b7c22d75842c7df90e82711e038))
...
-   **core:** CanvasContainer is now a PureComponent ([ec4c43e](https://github.com/reactivemarkets/react-candles/commit/ec4c43e2a15dbf50d60d9547633c4dab44398fe5))
...
-   **core:** fixing re-rendering of svg components ([af0f156](https://github.com/reactivemarkets/react-candles/commit/af0f156c66cd302ec8a45ff6c49e4121385b3ca9))

### Features

-   **core:** adding onDoubleClick to Chart ([1b6498b](https://github.com/reactivemarkets/react-candles/commit/1b6498b2fba108d930004ddbaaea6573692a1fb4))

# [1.0.0-alpha.0](https://github.com/reactivemarkets/react-candles/compare/v0.5.1...v1.0.0-alpha.0) (2020-07-08)

### Bug Fixes

-   **core:** only draw canvas if the draw function is defined ([354eb54](https://github.com/reactivemarkets/react-candles/commit/354eb5448b8b09dfea1d4515829af4172da9dcc0))
